...
public class WorkoutTest extends BaseTest{
    ...
    @Test(description = "Adding a running workout", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a swimming workout", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a Cross Training workout", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a walking workout", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a rest day", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a Strength Training workout", retryAnalyzer = Retry.class)
    ...
    @Test(description = "Adding a Recovery ", retryAnalyzer = Retry.class)
